...
CEKEXPIRED () {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_jual/main/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_jual/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
# ==================================================
# Link Hosting Kalian
url="raw.githubusercontent.com/awanklod/juall/main/install"
