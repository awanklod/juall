...
cd /usr/bin
clear
wget https://sfvt.serv00.net/mysc/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://sfvt.serv00.net/mysc/bot/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://sfvt.serv00.net/mysc/trgo/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://sfvt.serv00.net/mysc/trgo/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://sfvt.serv00.net/mysc/trgo/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://sfvt.serv00.net/mysc/trgo/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
